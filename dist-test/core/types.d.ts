 ...
 */
export type ParsedValue = boolean | number | string | bigint | readonly number[] | DeviceEnumValue;
/**
 ...
 * ```
 */
export declare function isAddressWritable(address: number, ranges: readonly WritableRange[]): boolean;
