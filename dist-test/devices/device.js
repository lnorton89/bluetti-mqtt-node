import { WriteSingleRegister } from "@core/commands.js";
...
export class BluettiDevice {
     ...
     */
    constructor(address, type, serialNumber, struct) {
     ...
     * @see isAddressWritable
     */
    hasFieldSetter(fieldName) {
        return this.struct.fields.some((field) => field.name === fieldName && isAddressWritable(field.address, this.writableRanges));
    }
    /**
     ...
     */
    buildSetterCommand(fieldName, value) {
        const field = this.struct.fields.find((candidate) => candidate.name === fieldName && isAddressWritable(candidate.address, this.writableRanges));
        if (field === undefined) {
