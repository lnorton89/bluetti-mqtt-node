...
import { buildAc200mStruct, buildAc300Struct, buildAc500Struct, buildAc60Struct, buildEb3aStruct, buildEp500Struct, buildEp600Struct, } from "./device-builders.js";
// ---------------------------------------------------------------------------
// Device table
// ---------------------------------------------------------------------------
export const BLUETTI_DEFINITIONS = [
    {
        type: "AC200M",
        packNumMax: 3,
        pollingCommands: [
...
export const BLUETTI_DEFINITION_MAP = new Map(BLUETTI_DEFINITIONS.map((def) => [def.type, def]));
export class BluettiDeviceModel extends BluettiDevice {
    def;
    constructor(address, serialNumber, def) {
