...
export class DeviceCommandRunner {
  constructor(
    ...
    private readonly enqueueDeviceWork: <T>(address: string, work: () => Promise<T>) => Promise<T>,
   ...
   */
  async handleCommand(message: CommandMessage<BluettiDevice, DeviceCommand>): Promise<void> {
