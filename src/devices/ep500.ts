/** EP500 register layout and AC300-family control enums. */
...
function buildEp500Struct(): DeviceStruct {
...
export class EP500 extends BluettiDevice {
  constructor(address: string, serialNumber: string) {
    super(address, "EP500", serialNumber, buildEp500Struct());
  }
