...
import type { WindowsHelperClient, HelperNotification } from "./helper-client.js";
 ...
 */
export class WindowsHelperTransport implements BluetoothTransport {
  ...
  async connect(address: string): Promise<void> {
    ...
    try {
      this.unsubscribeNotification = this.client.onNotification((event: HelperNotification) => {
 ...
 * helper client.
 */
export class WindowsHelperTransportFactory implements BluetoothTransportFactory {
  /**
